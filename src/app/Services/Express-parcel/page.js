    ...
    <>
      <main className="relative min-h-screen w-full pt-30">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/image/e (90).jpg" // Place the image in public folder and name it bg.jpg
            alt="Background"
            layout="fill"
            objectFit="cover"
            quality={100}
      ...
      <div className="bg-white py-16 px-4 sm:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-900 mb-4">
            <span className="text-blue-700">Drive efficiency</span> with scale
            to reach the remotest corners of India
          </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {segments.map(({ icon, title }, index) => (
              <div
                key={index}
                className="flex items-center space-x-4 hover:text-blue-600 transition duration-200"
              >
      ...
      <section className="bg-white px-6 py-20 lg:px-20">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-light text-blue-900">
            ...
            <span className="font-bold">technology driven</span> logistics
            platform
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
          {featuress.map((item, index) => (
            <div
              key={index}
              className="text-center px-4 hover:bg-blue-50 p-6 rounded-xl transition duration-300"
            >
      ...
      <section className="bg-blue-50 px-4 py-20 md:px-20">
        ...
        <div className="grid gap-10 md:grid-cols-3 max-w-7xl mx-auto">
          {services.map((service, index) => (
            <div
              key={index}
              className="relative group transition duration-300 transform hover:-translate-y-1"
            >
              ...
              {/* Decorative Dots */}
              {index === 0 && (
                <div className="absolute top-[35%] -left-2 w-3 h-3 bg-blue-500 rounded-full"></div>
              )}
              {index === 2 && (
                <div className="absolute bottom-[35%] -right-2 w-3 h-3 bg-blue-500 rounded-full"></div>
              )}
