      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10 pb-10">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="flex gap-4 mt-4 text-lg">
            ...
            <a
              href="https://www.linkedin.com/company/sureship-in/"
              target="_blank"
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li>
              <a href="/track" className="hover:text-[#38BDF8]">
                Tracking
              </a>
            </li>
            <li>
              <a href="/contactus" className="hover:text-[#38BDF8]">
                Contact Us
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li>
              <a href="/aboutus" className="hover:text-[#38BDF8]">
                About Us
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/careers" className="hover:text-[#38BDF8]">
                Careers
              </a>
            </li>
          </ul>
